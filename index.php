...
<body>
    ...
    <section id="sideber" class="sideber">
        <ul class="sideber__ber">
            ...
            <li id="left" class="sideber__item<?php if ( 'dashboard' == $id ) {
                ...
                <a href="index.php?id=dashboard"><i id="left" class="fas fa-tachometer-alt"></i>Home</a>
            </li>
    ...
    echo " active";
        ...
        <footer class="text-center"><span>PMS</span><br>©2021 PMS All right reserved.</footer>
    </section>
    <!--------------------------------- #Sideber -------------------------------->
